...
export const CottageDetailModal: React.FC<CottageDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-stone-950/80 backdrop-blur-sm flex items-center justify-center p-4 sm:p-6 animate-in fade-in duration-200">
      <div className="relative bg-white w-full max-w-4xl rounded-2xl shadow-2xl overflow-hidden my-8 text-stone-900 border border-stone-200">
        {/* Close Button */}
        <button
          onClick={onClose}
          id="close-cottage-modal-btn"
          className="absolute top-4 right-4 z-10 w-9 h-9 rounded-full bg-stone-900/70 hover:bg-stone-900 text-white flex items-center justify-center transition-colors shadow-md"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          ...
          <div className="lg:col-span-5 p-6 sm:p-8 flex flex-col justify-between overflow-y-auto max-h-[80vh] lg:max-h-[600px]">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 mb-6">
                <div className="flex items-center gap-2 p-2 rounded-lg bg-stone-100 text-stone-700 text-xs">
                ...
                <div className="flex items-center gap-2 p-2 rounded-lg bg-stone-100 text-stone-700 text-xs col-span-2">
            ...
            <div className="pt-4 border-t border-stone-200 space-y-2.5">
              <button
                ...
                className="w-full py-3 rounded-xl bg-amber-600 hover:bg-amber-500 text-white font-semibold text-sm shadow-md transition-colors flex items-center justify-center gap-2"
              >
              ...
              <div className="grid grid-cols-2 gap-2">
                <a
                  ...
                  className="py-2.5 px-3 rounded-xl bg-emerald-700 hover:bg-emerald-600 text-white text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors"
                >
                ...
                <a
                  ...
                  id="modal-call-btn"
                  className="py-2.5 px-3 rounded-xl bg-stone-100 hover:bg-stone-200 text-stone-800 text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors border border-stone-300"
                >
